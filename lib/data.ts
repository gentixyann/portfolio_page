...
export const values: Value[] = [
  {
    no: "01",
    title: "AIと共に、領域を越える",
    body: "アプリ・フロント・バックエンド・デザイン。必要に応じて職種や技術の境界を越えて手を動かす。AIと共に、未知の領域へ踏み込み、越えられる境界そのものを広げています。スタートアップで培った「まず作って確かめる」姿勢を大切にしています。",
  },
  {
    no: "02",
    title: "体験そのものを設計する",
...
export const sideWork: SideWork[] = [
  ...
  {
    name: "合同会社モテアソブ三軒茶屋",
    description: "イベント企画やWebサイト制作、プロジェクトマネジメントからライター業務まで幅広い案件を経験。",
